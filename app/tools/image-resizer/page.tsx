...
import { ArrowLeft, Crop, Download } from 'lucide-react';
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="bg-white dark:bg-gray-800 rounded-3xl shadow-sm border dark:border-gray-700 p-8">
          <div className="flex items-center mb-6">
            <Crop className="h-8 w-8 text-blue-600 dark:text-blue-400 mr-3" />
            <h1 className="text-3xl font-bold text-gray-900 dark:text-white">Image Resizer</h1>
          </div>
          <p className="text-gray-600 dark:text-gray-300 mb-8">
            Upload an image and resize it to custom dimensions for faster page loads and cleaner Shopify assets.
          </p>
          ...
          {resultUrl && (
            <div className="mt-8 rounded-3xl bg-gray-50 dark:bg-gray-900 border border-gray-200 dark:border-gray-700 p-6">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div className="rounded-2xl overflow-hidden bg-white dark:bg-gray-800 p-4">
                  <img src={resultUrl} alt="Resized preview" className="w-full object-contain" />
                </div>
                <div className="space-y-4">
                  <p className="text-gray-600 dark:text-gray-300">Resized dimensions: {width} x {height}</p>
                  <p className="text-gray-600 dark:text-gray-300">Resized size: {formatBytes(resizedSize)}</p>
                  <a
                    href={resultUrl}
